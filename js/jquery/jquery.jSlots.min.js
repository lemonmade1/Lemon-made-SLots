...
(function (a) {
  a.jSlots = function (c, b) {
    ...
    $.jSlots.defaultOptions = {
      ...
      winnerNumber: 1,      // Number or Array: list item number(s), 1-based index, !ZERO-BASED,
      spinner: '',          // CSS Selector: element to bind the start event to,
      spinEvent: 'click',   // String: event to start slots on this event,
      onStart: $.noop,      // Function: runs on spin start,
      onEnd: $.noop,        // Function: finalNumbers gives the index of the li each slot stopped on,
      easing: 'swing',      // String: easing type for spin. (Recommended: easeOutSine or easeOut),
    ...
    d.checkWinner = function (f, g) {
      ...
      if (d.doneCount === d.options.number) {
        ...
        if (a.isFunction(d.options.onWin)) { // MODIFIED (d.winCount && a.isFunction(...)
